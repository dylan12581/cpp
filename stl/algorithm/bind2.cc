...
void test1(){
    ...
    cout << f() << endl;
    function<int(int,int)> f2 = bind(&multiply,1,_1,_2);
    cout << f2(2,3) << endl;

    function<int()> f3 = bind(&Example::mul,1,2);
    cout << f3() << endl;

    Example ex;
    //function<int()> f4 = bind(&Example::_data,ex);
    //function<int()> f4 = bind(&Example::_data,&ex);
    function<int(Example)> f4 = bind(&Example::_data,_1);
    cout << f4(ex) << endl;
