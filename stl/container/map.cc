...
void test0()
{
    ...
    cout << "===插入===" << endl;
    pair<map<string,Point>::iterator,bool> ret = num.insert({"hello",Point(7,7)});
    if(ret.second)
    {
   ...
   // 通过key值进行删除 
    ...
    cout << "cnt" << cnt << endl;
    map<string,Point>::iterator ret2 = num.find("shaoxing");
    if(ret2 == num.end()){
    ...
    cout << "bound系列函数" << endl;
    map<string,Point>::iterator bd1 = num.lower_bound("wuhan");
    cout << "lower_bound:" << bd1->first << bd1->second << endl;
    map<string,Point>::iterator bd2 = num.upper_bound("shaoxing");
    cout << "upper_bound:" << bd2->first << bd2->second << endl;
    pair<map<string,Point>::iterator,map<string,Point>::iterator> bd3 = num.equal_range("shaoxing");
    cout << "equal_range:";
